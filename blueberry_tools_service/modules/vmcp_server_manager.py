            ...
            with open(VMCP_SERVERS_FILE, 'r') as f:
                ...
                for server_data in data:
                    try:
                        ...
                        logger.error(f"Failed to load vmcp_server: {server_data.get('name', 'unknown')}. Error: {str(e)}")
        except FileNotFoundError:
            logger.info(f"{VMCP_SERVERS_FILE} not found. Starting with empty list of vmcp_servers.")
        except Exception as e:
