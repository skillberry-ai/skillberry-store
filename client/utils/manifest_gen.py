...
parser = argparse.ArgumentParser(description="Generate manifests for all functions in a given folder")
parser.add_argument("jsonpath", type=str, help="A path to a folder containing the JSON descriptions")
parser.add_argument("codepath", type=str, help="A path to the module containing all the functions in modules")
