...
export function AnthropicSkillImporter({
  ...
  const handleBatchImport = async (_tags: string[]) => {
    setProgress(100);
    throw new Error(
      'Batch import requires backend filesystem access that has been removed. Please import each Anthropic skill individually from the frontend.'
    );
  };
