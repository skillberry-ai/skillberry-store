        ...
        <Card style={{ marginTop: '1rem' }}>
          ...
          <CardBody>
            <div style={{
              ...
              <SyntaxHighlighter
                language={
                  snippet.content_type?.includes('python') ? 'python' :
                  snippet.content_type?.includes('javascript') ? 'javascript' :
                  snippet.content_type?.includes('java') ? 'java' :
                  snippet.content_type?.includes('go') ? 'go' :
                  snippet.content_type?.includes('sh') || snippet.content_type?.includes('bash') ? 'bash' :
                  snippet.content_type?.includes('yaml') ? 'yaml' :
                  snippet.content_type?.includes('json') ? 'json' :
                  snippet.content_type?.includes('html') ? 'html' :
                  snippet.content_type?.includes('css') ? 'css' :
                  'text'
                }
                style={vscDarkPlus}
