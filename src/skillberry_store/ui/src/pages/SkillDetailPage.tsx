                        ...
                        {selectedSnippet ? (
                          <div>
                            ...
                            <div style={{
                              ...
                              <SyntaxHighlighter
                                language={
                                  selectedSnippet.content_type === 'text/x-python' ? 'python' :
                                  selectedSnippet.content_type === 'text/javascript' ? 'javascript' :
                                  selectedSnippet.content_type === 'text/x-java' ? 'java' :
                                  selectedSnippet.content_type === 'text/x-go' ? 'go' :
                                  selectedSnippet.content_type === 'text/x-sh' ? 'bash' :
                                  selectedSnippet.content_type === 'text/x-yaml' ? 'yaml' :
                                  selectedSnippet.content_type === 'application/json' ? 'json' :
                                  selectedSnippet.content_type === 'text/html' ? 'html' :
                                  selectedSnippet.content_type === 'text/css' ? 'css' :
                                  'text'
                                }
                                style={vscDarkPlus}
                                showLineNumbers={true}
