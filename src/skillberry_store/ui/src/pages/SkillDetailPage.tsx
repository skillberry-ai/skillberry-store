...
import { determineLanguage } from '@/utils/languageMapper';
                            ...
                            <div style={{
                              ...
                              <SyntaxHighlighter
                                language={determineLanguage(
                                  skill?.tools?.find(t => t.name === selectedToolModule.name)?.module_name,
                                  undefined,
                        ...
                        {selectedSnippet ? (
                          <div>
                            ...
                            <div style={{
                              ...
                              <SyntaxHighlighter
                                language={determineLanguage(
                                  getFilePathFromTags(selectedSnippet.tags || []),
                                  selectedSnippet.content_type
                                )}
                                style={vscDarkPlus}
                                showLineNumbers={true}
                                wrapLines={false}
