                        ...
                        {selectedSnippet ? (
                          <div>
                            ...
                            <div style={{
                              ...
                              <SyntaxHighlighter
                                language={selectedSnippet.content_type?.includes('python') ? 'python' : 
                                         ...
                                         selectedSnippet.content_type?.includes('sh') ? 'bash' :
                                         ...
                                         selectedSnippet.content_type?.includes('css') ? 'css' : 'text'}
                                style={vscDarkPlus}
                                showLineNumbers={true}
                                wrapLines={false}
                                customStyle={{
